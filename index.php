...
<head>
	<title>PLUG UPP | Index Page</title>
	<!-- custom-theme -->
			...
			<div class="header_agileits">
				...
				<div class="top_nav_right">
					<div class="shoecart shoecart2 cart cart box_1">
						<form action="view/cart.php" method="post" class="last">
							<!-- <input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="display" value="1">-->
							<!-- <a href="view/cart.php"><button class="top_shoe_cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button></a> -->
					...
					<ul class="rslides callbacks callbacks1" id="slider4">
						...
						<li>
							<div class="banner-top1">
								<div class="banner-info-wthree">
									<h3>Adidas</h3>
									<p>The brand with the III stripes</p>
		...
		<div class="col-md-6 style-grid style-grid-2">
			<div class="style-image-1_info">
				<div class="style-grid-2-text_info">
					<h3>Nike Jordans</h3>
					<p>The radiance lives on with the b-ball original. Celebrating 50 years of Nike innovation, it lets you step back in time with '70s-styled graphics and vintage colours. Let peace, love and sport bring you nothin'-but-net style.</p>
					<div class="shop-button">
						<a href="view/shop.php">Shop Now</a>
					</div>
				</div>
			</div>
		...
		<div class="style-grids_main">
			<div class="col-md-6 grids_sec_2_left">
				<div class="grid_sec_info">
					<div class="style-grid-2-text_info">
						<h3>Converse</h3>
						<p>The high-top, court favorite gets a bold, nostalgic redesign that puts '90s expression first. The cotton canvas upper features pop-color binding details that add a retro touch to the icon. An expressive marbled ink pattern lends itself to the tongue, star ankle patch,
							 and heel stay. The look is finished with Chuck Taylor All Star classics, like a rubber toe bumper, toe cap, and diamond pattern outsole. Get bold.</p>
						<div class="shop-button">
							<a href="view/shop.php">Shop Now</a>
						</div>
					</div>
			...
			<div class="col-md-6 grids_sec_2_left">
				...
				<div class="grid_sec_info last">
					<div class="style-grid-2-text_info">
						<h3>Vans</h3>
						<p>the Authentic is the original Vans heritage style. Originally know as Vans #44 Deck Shoes, the Authentic became an immediate cult icon, and has embodied our “Off The Wall” attitude ever since. 
							Constructed with a simple low top, lace-up profile, this classic shoe also features sturdy canvas uppers, metal eyelets, and signature rubber waffle outsoles.
	</p>
