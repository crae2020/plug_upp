...
<body class="cbp-spmenu-push">
  ...
  <?php 
	...
	$productlist = select_all_products_ctrl();
...
?>
  <tbody>
	<!-- <script src="../js/upload_book.js"></script> -->
		...
		<tr>
			<input type="hidden" value="<?php echo $product['product_id']?>" id="pid" name="pid">
			<td>
			...
			<form action="updateproduct.php" method="GET"> 
				...
				<button type="submit" name="submit" class="update_button">Update
				</button>
			</form>

			<form action="../actions/delproduct.php" method="POST"> 
				<input type="hidden" value="<?php echo $product['product_id'] ?>" name="pid" id="pid">
