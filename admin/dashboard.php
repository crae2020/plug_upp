...
$revenue = get_total_revenue_ctrl();
$allproducts = get_all_products_ctrl();
$allbrands = get_all_brands_ctrl();
$allcategories = get_all_categories_ctrl();
$allusers = get_all_users_ctrl();
// echo ($allusers);
            ...
            <aside class="sidebar-left">
                <nav class="navbar navbar-inverse">
                    <div class="navbar-header">
                        ...
                        <h1><a class="navbar-brand" href="dashboard.php"><span class="fa fa-area-chart"></span><img src="../images/plug_upp_w.svg" alt="logo" style="width: 60px;"><span class="dashboard_text"></span></a></h1>
                    </div>
                ...
                <div class="col_3">
                    ...
                    <div class="col-md-3 widget">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong><?php
                                    echo $allusers[0]['COUNT(customer_id)'];
                                ?></strong></h5>
                    ...
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong><?php echo $allproducts[0]['COUNT(product_id)']; ?></strong></h5>
                    ...
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                            <h5><strong><?php echo $allbrands[0]['COUNT(brand_id)']; ?></strong></h5>
                    ...
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                            <h5><strong><?php echo $allcategories[0]['COUNT(cat_id)']; ?></strong></h5>
                                <span>Categories</span>
                            </div>
                        </div>
                    </div>
