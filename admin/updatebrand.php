...
$bid = $_GET['bid'];
$brand_detail = select_one_brand_ctrl($bid);
			...
			<div class="main-page">
				<div class="media">
					...
					<div class="bs-example5 widget-shadow" data-example-id="default-media">
						...
						<form action="../actions/updatebrandproc.php" method="POST">
							<div class="mb-3">
								<label for="author_name" class="form-label">Brand name</label>
                                <input type="hidden" id= "brand_id" name="brand_id" value="<?php echo($bid)?>">
								<input type="text" class="form-control" id="update_brand" name="update_brand" value="<?php echo($brand_detail['brand_name'])?>" aria-describedby="emailHelp">
								<div id="author_help" class="form-text">Update the Brand name</div>
							</div>
