...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="media">
					<h2 class="title1">Upload a Shoe</h2>
					<div class="bs-example5 widget-shadow" data-example-id="default-media">
						...
						<form action='../actions/addproductproc.php'method="POST" enctype='multipart/form-data'>
						
						
						<div>
						<label for="title" class="form-label">Shoe Category</label>
						<select name= "category" id= "category" class="form-select" aria-label="Default select example" id="status">
							<?php
					...
					<div>
						...
						<select name= "brand" id= "brand" class="form-select" aria-label="Default select example" id="status">
							<?php
							...
							<div class="mb-3">
								...
								<input type="text" name="ptitle" id="ptitle" class="form-control" id="title" aria-describedby="emailHelp" required>
							</div>
							<div class="mb-3">
								<label for="id" class="form-label">Shoe Price</label>
								<input type="number" name="pprice" id="pprice" required class="form-control" id="id" aria-describedby="emailHelp">
							</div>
							<div class="mb-3">
								<label for="description" class="form-label">Shoe description</label>
								<textarea class="form-control" name="pdescr" id="pdescr" required rows="3"></textarea>
							</div>
							<div class="mb-3">
								<label for="price" class="form-label">Shoe Image</label>
								<input type="file" class="form-control" name="pimage" id="pimage" aria-describedby="emailHelp">
							</div>
							<div class="mb-3">
								<label for="publish_date" class="form-label">Shoe Keywords</label>
								<input type="text" name="pkey" id="pkey" required class="form-control" id="publish_date" aria-describedby="emailHelp">
							</div>
					
							<button type="submit" name= "add_product" class="btn btn-primary">Add Shoe</button>
