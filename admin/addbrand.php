		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="media">
					...
					<h2 class="title1">Add Brand</h2>
					<div class="bs-example5 widget-shadow" data-example-id="default-media">
						<!-- Button trigger modal -->

						<form action="../actions/brandproc.php" method="POST">
							<div class="mb-3">
								<label for="author_name" class="form-label">Brand name</label>
								<input type="text" class="form-control" id="brand_name" name="brand_name" aria-describedby="emailHelp">
								<div id="author_help" class="form-text">Enter the Brand name</div>
							</div>
						
							<button type="submit" onclick="document.location= 'viewbrand.php'" class="btn btn-primary">Submit</button>
						</form>
					</div>
