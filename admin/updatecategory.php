...
print_r($cat_detail);
    ...
    echo($cname_update);
    $check_update = update_all_categories_ctrl($cid, $cname_update);
    if ($check_update) {
			...
			<div class="main-page">
				<div class="media">
					...
					<div class="bs-example5 widget-shadow" data-example-id="default-media">
						...
						<form action="../actions/updatecategoryproc.php" method="POST">
							<div class="mb-3">
								<label for="author_name" class="form-label">Category name</label>
                                <input type="hidden" id= "cat_id" name="cat_id" value="<?php echo($cid)?>">
								<input type="text" class="form-control" id="update_category" name="update_category" value="<?php echo$cat_detail['cat_name']?>" aria-describedby="emailHelp">
								<div id="author_help" class="form-text">Update the Category name</div>
							</div>
