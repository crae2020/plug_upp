			...
			<div class="main-page">
				<div class="media">
					...
					<div class="bs-example5 widget-shadow" data-example-id="default-media">
						...
						<form action="../actions/categoryproc.php" method="POST">
							<div class="mb-3">
								<label for="author_name" class="form-label">Category name</label>
								<input type="text" class="form-control" id="cat_name" name="cat_name" aria-describedby="emailHelp">
								<div id="author_help" class="form-text">Enter the Category name</div>
							</div>
						
							<button type="submit" onclick="document.location= 'viewcat.php'" class="btn btn-primary">Submit</button>
						</form>
					</div>
