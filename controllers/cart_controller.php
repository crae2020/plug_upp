...
function count_one_cart_ctrl($cid){
  ...
  function duplicate_all_cart_ctrl($pid, $cid){

    $duplicate_cart = new cart_class();
  
    return $duplicate_cart -> duplicate_all_cart($pid, $cid);
  }
  ...
  function every_cart_item_ctrl($cid){
  ...
  function get_from_cart_ctrl($a){
    $get_add = new cart_class();
    
    return $get_add->get_from_cart($a);
...
function delete_cart_qty_ctrl($pid, $cid){
  ...
  function get_cart_ctrl($cid){
    $get_cart = new cart_class();
  
    return $get_cart -> get_cart($cid);
  }
