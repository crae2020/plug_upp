...
<head>
	<title>PLUG UPP | Checkout Page</title>
	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<div class="privacy about">
				...
				<div class="checkout-right">
					...
					<table class="timetable_sub">
						...
						?>
								...
								<tr class="rem1">
								<td class="invert"><?php echo $cart_one['product_id'] ?></td>
								...
								<td class="invert">
									<div class="quantity">
										<div class="quantity-select">
											...
											<div class="entry value" style="color: #000;"><span><?php echo $cart_one['qty']?></span></div>
					...
					<div class="col-md-4 checkout-left-basket">
						...
						<ul>
							...
							<li>Total<i>:</i> <span style="color: #000;">GH¢  <?php echo $total_price['SUM(cart.qty * products.product_price)']?></span></li>
				...
				<div class="checkout-left">
					<div class="col-md-4 checkout-left-basket">
						<a href="payment.php"><h4>Proceed to Payment</h4> </a>
