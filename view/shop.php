						...
						<div class="product-shoe-info shoe"  >
								...
								<div class="men-pro-item" >
									<div class="men-thumb-item" >
										<img src="<?php echo $product['product_image'] ?>" alt="" style="height: 216px; " >
								
									</div>
									<div class="item-info-product">
										<h4>
											<a href="single.php?product_id=<?php echo $product['product_id'] ?>"><?php echo $product['product_title'] ?> </a>
										</h4>
										<div class="info-product-price">
											<div class="grid_meta">
												<div class="product_price">
													<div class="grid-price ">
														<span class="money ">GHS <?php echo $product['product_price'] ?></span>
													</div>
												</div>
												<ul class="stars">
